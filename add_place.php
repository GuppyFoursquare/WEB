...
$header_title = "YOUBAKU | Add Place";
...
if(!empty($_POST)){
    ...
    if($name != '' && $email != '' && $phone != '' && $subject != '' && $message != '' && $place_name != '')
    {
        ...
        $msg = "Hello admin,  <br/><br/> ".
                "The following user has posted a request to add his place to the website. <br/>The details are as follows.<br/><br/>".
                "Name: ".$name."<br/>
                 Place name: ".$place_name."<br/>
                 Email: ".$email."<br/>
                 Phone: ".$phone."<br/>
                 Subject: ".$subject."<br/>
                 Message: ".$message."<br/>
        ...
        $to = $email;
        $subject = "Youbaku - request to add place.";
        $msg = "Hello ".$name.",  <br/><br/> Thank you for your interest in registering your place with us. We will get back to you soon.<br/><br/>Thank you.<br/>Youbaku Support Team.<br/>".
                "<a href=\"http://www.youbaku.az/index.php\"> www.youbaku.az</a>";
        $headers = "MIME-Version: 1.0" . "\r\n".
                   "Content-type: text/html; charset=iso-8859-1" . "\r\n".
        ...
        if($mail_sent)
        {
            $_SESSION['sucess_message'] = "Your request sent successfully.";
        }
        else
        {
...
include("template/add_place.php");
?>

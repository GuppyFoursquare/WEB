...
if($_REQUEST['cnt_id'] != '') $sPageTitle     = "Edit Off Menu";
else $sPageTitle     = "Add Off Menu";

$sPageClass     = "addoffmenu";
$iPageSelect    = 8;
$iProcess       = 1;
$_SESSION['mid_breadcum']       = "";
$_SESSION['mid_breadcum_url']   = "";
$_SESSION['parent_breadcum']    = 'Off Manu';
$_SESSION['parent_breadcum_url']= 'off_menu.php';
...
switch($iProcess){
    case 2:
        ...
        break;
    case 3:
            $_SESSION['error_message'] = "Off Menu extension should be jpg,jpeg,png or gif";
        break;
    case 4:
            $_SESSION['error_message'] = "Off Menu extension should be jpg,jpeg,png or gif";
        break;
    case 5:
            $_SESSION['error_message'] = "Off Menu url already exist.";
        break;
    case 6:
            $_SESSION['sucess_message'] = "Off Menu successfully added.";
            header("location:off_menu.php");
            die();
        break;
    case 7:
            $_SESSION['sucess_message'] = "Off Menu successfully updated.";
            header("location:off_menu.php");
            die();
        break;
}
...
#OUTPUT ------------------------------------------------------------------------
include("templete/add_edit_off_menu.inc.php");
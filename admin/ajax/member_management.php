...
if (isset($_GET['sSearch']) && $_GET['sSearch'] != ""  )
{
    ...
    if ( $sWhere == "" ){
        $sWhere=" WHERE  usr_delete =0 AND usr_user_type='U'";
    }else{
	...
	while ( $aRow = mysql_fetch_array( $rResult ) )
	{
            ...
            for ( $i=0 ; $i<count($aColumns) ; $i++ )
            {
                    ...
                    $action='<a class="" href="add_edit_member.php?usr_id='.stripslashes(base64_encode($aRow[ $aColumns[$i] ])).'"><img src="images/edit.png" style="cursor:pointer"  border="0" title="Edit" /></a>';
                    ...
                    $action='<a class="" href="change_password.php?usr_id='.stripslashes(base64_encode($aRow[ 'changepassword' ])).'"><img src="images/change_pass.png" style="cursor:pointer"  border="0" title="Change Password" /></a>';
                    $row[] = $action;

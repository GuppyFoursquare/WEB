...
function K(ac){
    ...
    if(X!=ac){
        ...
        if(!ae){
            ae=p.add(N.documentElement,"div",{
                id:"mceResizeHandle"+ad,
                "class":"mceResizeHandle",
                style:"cursor:"+ad+"-resize; margin:0; padding:0"
                });
        ...
        p.setStyles(ae,{
        left:(ab*af[0]+I)-(ae.offsetWidth/2),
        top:(Z*af[1]+H)-(ae.offsetHeight/2)
        })
    });

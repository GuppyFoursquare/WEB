                                ...
                                <form action="" method="post" name="frmnews" id="frmnews" enctype="multipart/form-data">
                                    ...
                                    <table  border="0" cellspacing="0" align="left" cellpadding="2" class="formtopbox add_edit_section" style=" margin-left:17px">
										...
										<tr>
                                            ...
                                            <td align="left" style="font-size:13px" ><?php echo SERVER_FRONT_PATH.'content/';?><input type="text" name="cnt_url_name" id="cnt_url_name" maxlength="100"  value="<?php echo isset($sPageUrl) ? stripslashes($sPageUrl) : stripslashes($sPageUrl); ?>" class="display_text" onkeypress="return keyRestrict(event,'abcedfghijklmnopqrstuvwxyz1234567890-_')" style="width:330px!important" />&nbsp;
                                                <br/>
										...
										<tr>
                                           ...
                                           if ($iCntID == '') {
                                               ...
                                               echo 'Update';
                                                ...
                                                <input name="back" value="Cancel" id="Back" type="button" class="button left_menu_option" onclick="location.href='content.php?isCancelButtonClicked=1'" />
                                            </td>
                                        </tr>
                                    </table>
                                </form>

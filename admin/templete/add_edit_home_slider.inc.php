...
$(document).ready(function(){
    $("#Save").click(function(){
		...
		slide_link : { required: true, url: true}
		...
		slide_link : { required: "Please enter valid link.", url: "Please enter a valid link." }
		...
		slide_link : { required: "Please enter valid url.", url: "Please enter a valid link." }
                        ...
                        <tr>
                            <td style="">
                                <form action="#" method="post" name="frmslider" id="frmslider" enctype="multipart/form-data">
                                    <input type="hidden" name="slide_id" value="<?php echo $_REQUEST['home_slider_id']; ?>"/>
                                    <table  border="0" cellspacing="0" align="left" cellpadding="2" class="formtopbox add_edit_section" style=" margin-left:17px">
                                        ...
                                        <tr>
                                            ...
                                            <td align="left" ><input type="text" name="slide_title" id="slide_title" maxlength="100"  value="<?php echo isset($sSliderTitle) ? html_entity_decode($sSliderTitle) : ''; ?>" class="display_text" />&nbsp;
                                                <br/>
                                        ...
                                        <tr>
											...
											<br/>
                                                ...
                                                <div>Please enter an image of size at least 1024px x 768px </div>
											</td>
                                        </tr>
                                        ...
                                        <tr>
                                           ...
                                           if ($iSlideID == '') {
                                               ...
                                               echo 'Update';
                                                ...
                                                <input name="back" value="Cancel" id="Back" type="button" class="button left_menu_option" onclick="location.href='home_slider.php?isCancelButtonClicked=1'" />
                                            </td>
                                        </tr>
                                    </table>
                                </form>

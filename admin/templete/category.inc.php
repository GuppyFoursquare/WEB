...
<script type="text/javascript" >
    $(document).ready(function() {
        ...
        $('#catMasterTable').dataTable( {
            ...
            "sAjaxSource": "./ajax/category_management.php"
        });
...
function set_order(){
	window.location.href='category.php?isCancelButtonClicked=1&set_order=1';
}
                                ...
                                <form name="frmSearch" id="frmSearch" method="post" action="">
                                    ...
                                    <div style=" float:left; position:absolute;" class="formtopbox">
                                        <div style="left:0px; float:right; z-index:1; float:left; position:relative;">
                                            <div class="white12" style="vertical-align:middle;float:left;padding: 8px 5px;"><p>Category:</p></div>
                                            <div style="float:left;margin-right: 10px;">
                                                <input type="text" name="cat_name" id="cat_name" style="width:90px;" value="<?php 
												if(isset($_REQUEST['set_order'])){
													$Sessinocat_name="";
												}
												else{$Sessinocat_name=$_SESSION['Sessinocat_name'];
												}
												
												echo isset($Sessinocat_name) ? stripslashes($Sessinocat_name) : ''; ?>"/>
                                            </div>
                                        </div>
                                    ...
                                    <div style="right:0px; float:right; z-index:1; position:relative;">
                                        ...
                                        <input type="button" name="add_edit" value="Add Category" id="add_edit" style="width:auto" onclick="location.href='add_edit_category.php'" class="button add_edit_member"/>
                                    </div>
                                    </div>
                                </form>
                            </td>
                                        ...
                                        <table cellpadding="0" cellspacing="0" border="0" class="display" id="catMasterTable" width="100%">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="blue_bg_header">CATEGORIES</th>
                                                    <th class="blue_bg_header no-sort">SUB CATEGORY</th>

...
<script type="text/javascript" >
    $(document).ready(function() {
        ...
        $('#contentMasterTable').dataTable( {
            ...
            "aaSorting": [[2,'asc']],//default coloumn for sort and sort type
            ...
            "sAjaxSource": "./ajax/content_management.php"
        });
...
function searchTable(){
	...
	search("contentMasterTable");
	
}    

function clearFilter(){
    $('#question').val('');
	$('#contentMasterTable').dataTable({ "bRetrieve": true }).fnSort([]);
    search("contentMasterTable");
}
                                ...
                                <form name="frmSearch" id="frmSearch" method="post" action="">
                                    ...
                                    <div style=" float:left; position:absolute;" class="formtopbox">
                                        <div style="left:0px; float:right; z-index:1; float:left; position:relative;">
                                            <div class="white12" style="vertical-align:middle;float:left;padding: 8px 5px;font-size: 13px !important;">Question: </div>
                                    ...
                                    <div style="right:0px; float:right; z-index:1; position:relative;">
                                        ...
                                        <input type="button" name="add_edit" value="Add FAQ" id="add_edit" style="width:auto" onclick="location.href='add_edit_faq.php'" class="button add_edit_member"/>
                                    </div>
                                    </div>
                                </form>
                            </td>
                            ...
                            <td>
                                <form id="change_order" name="change_order" method="post">
                                    ...
                                    <div class="grid_content">
                                        <table cellpadding="0" cellspacing="0" border="0" class="display" id="contentMasterTable" width="100%">
                                            <thead>
                                                <tr>

...
<script type="text/javascript" >
    $(document).ready(function() {
        ...
        $('#countryMasterTable').dataTable( {
            ...
            "sAjaxSource": "./ajax/country_management.php"
        });
...
function searchTable(){
	...
	search("countryMasterTable");
	
}    

function clearFilter(){
    $('#question').val('');
	$('#countryMasterTable').dataTable({ "bRetrieve": true }).fnSort([]);
    search("countryMasterTable");
}
                                ...
                                <form name="frmSearch" id="frmSearch" method="post" action="">
                                    ...
                                    <div style=" float:left; position:absolute;" class="formtopbox">
                                        <div style="left:0px; float:right; z-index:1; float:left; position:relative;">
                                            <div class="white12" style="vertical-align:middle;float:left;padding: 8px 5px;font-size: 13px !important;">Country: </div>
                                    ...
                                    <div style="right:0px; float:right; z-index:1; position:relative;">
                                        ...
                                        <input type="button" name="add_edit" value="Add Country" id="add_edit" style="width:auto" onclick="location.href='add_edit_country.php'" class="button add_edit_member"/>
                                    </div>
                                    </div>
                                </form>
                            </td>
                            ...
                            <td>
                                <form id="change_order" name="change_order" method="post">
                                    ...
                                    <div class="grid_content">
                                        <table cellpadding="0" cellspacing="0" border="0" class="display" id="countryMasterTable" width="100%">
                                            <thead>
                                                <tr>

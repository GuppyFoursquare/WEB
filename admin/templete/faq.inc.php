...
<script type="text/javascript" >
    $(document).ready(function() {
        ...
        $('#faqMasterTable').dataTable( {
            ...
            "sAjaxSource": "./ajax/faq_management.php"
        });
...
function searchTable(){
	...
	search("faqMasterTable");
	
}    

function clearFilter(){
    $('#question').val('');
	$('#faqMasterTable').dataTable({ "bRetrieve": true }).fnSort([]);
    search("faqMasterTable");
}
                            ...
                            <td>
                                <form id="change_order" name="change_order" method="post">
                                    ...
                                    <div class="grid_content">
                                        <table cellpadding="0" cellspacing="0" border="0" class="display" id="faqMasterTable" width="100%">
                                            <thead>
                                                <tr>
																																		<th class="blue_bg_header no-sort">SEQ. NO.</th>
													<th class="blue_bg_header">QUESTION</th>

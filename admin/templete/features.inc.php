    ...
    $(document).ready(function() {
        ...
        $('#featuresMasterTable').dataTable( {
            ...
            "fnServerParams": function ( aoData ) {
                aoData.push( { "name": "feature_title", "value": $('#feature_title').val() } );	//to search paramatert
            },
            "aoColumnDefs" : [ {
                    "bSortable" : false,
                    "aTargets" : [ "no-sort" ]
            ...
            "sAjaxSource": "./ajax/features_management.php"
        });
        ...
        //clearFilter();
		$('#featuresMasterTable').dataTable({ "bRetrieve": true }).fnSort([]);
...
function set_order(){
	...
	window.location.href='features.php?isCancelButtonClicked=1&set_order=1';
}
...
function save_order(){
    var chks = document.getElementsByName('chorder[]');
          ...
          if (chks[i].value==""){
			...
			alert("Please fillup all the text boxes");
			chks[i].focus();
			return false;}
}
</script>
                            ...
                            <td style="">
                                <form name="frmSearch" id="frmSearch" method="post" action="">
                                    ...
                                    <div style=" float:left; position:absolute;" class="formtopbox">
                                        <div style="left:0px; float:right; z-index:1; float:left; position:relative;">
                                            ...
                                            <div style="float:left;margin-right: 10px;">
                                                <input type="text" name="feature_title" id="feature_title" style="width:90px;" value="<?php echo isset($_SESSION['Sessinofeature_title']) ? stripslashes($_SESSION['Sessinofeature_title']) : ''; ?>"/>
                                            </div>
                                        </div>
                                    ...
                                    <div style="right:0px; float:right; z-index:1; position:relative;">
                                        ...
                                        <input type="button" name="add_edit" value="Add Feature" id="add_edit" style="width:auto" onclick="location.href='add_edit_features.php'" class="button add_edit_member"/>
                                    </div>
                                    </div>
                                </form>
                            </td>
                            ...
                            <td>
                                <form id="change_order" name="change_order" method="post">
                                    ...
                                    <div class="grid_content">
                                        <table cellpadding="0" cellspacing="0" border="0" class="display" id="featuresMasterTable" width="100%">
                                            <thead>
                                                <tr>
													<th class="blue_bg_header no-sort">SEQ. NO.</th>
                                                    <th class="blue_bg_header">TITLE</th>
													<th class="blue_bg_header no-sort">ICON</th>
													<th class="blue_bg_header">CHANGE ORDER</th>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td colspan="5" class="dataTables_empty" style="font-size:13px;">Please wait.. fetching records.</td>
                                                </tr>
                                            </tbody>
                                            <tfoot>
                                            </tfoot>

    ...
    $(document).ready(function() {
        ...
        $('#sliderMasterTable').dataTable( {
            ...
            "fnServerParams": function ( aoData ) {
                aoData.push( { "name": "home_slider_title", "value": $('#slide_title').val() } );	//to search paramatert
            },
            "aoColumnDefs" : [ {
                    "bSortable" : false,
                    "aTargets" : [ "no-sort" ]
            ...
            "sAjaxSource": "./ajax/home_slider_management.php"
        });
...
function searchTable(){
    search("sliderMasterTable");
}    

function clearFilter(){
    $('#slide_title').val('');
	$('#sliderMasterTable').dataTable({ "bRetrieve": true }).fnSort([]);
    search("sliderMasterTable");
}

function set_order(){
    window.location.href='home_slider.php?isCancelButtonClicked=1&set_order=1';
}
                            ...
                            <td style="">
                                <form name="frmSearch" id="frmSearch" method="post" action="">
                                    ...
                                    <div style="right:0px; float:right; z-index:1; position:relative;">
                                        ...
                                        <input type="button" name="add_edit" value="Add Image" id="add_edit" style="width:auto" onclick="location.href='add_edit_home_slider.php'" class="button add_edit_member"/>
                                    </div>
                                    </div>
                                </form>
                            </td>
                            ...
                            <td>
                                <form id="change_order" name="change_order" method="post">
                                    ...
                                    <div class="grid_content">
                                        <table cellpadding="0" cellspacing="0" border="0" class="display" id="sliderMasterTable" width="100%">
                                            <thead>
                                                <tr>
                                                    <th class="blue_bg_header no-sort">SEQ. NO.</th>
                                                    <th class="blue_bg_header">TITLE</th>
                                                    <th class="blue_bg_header no-sort">IMAGE</th>

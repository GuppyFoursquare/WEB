                                        ...
                                        <div class="row eg-main">
                                            <div class="col-sm-9">
                                                <div class="eg-wrapper">
                                                    <img class="cropper" src="<?= "../".PLACES_HEADER_IMAGE_ORG . $sImageName ?>" alt="Picture">
                                                </div>
                                            </div>
                                            <div class="col-sm-3">
...
<script>
    $(window).load(function () {
        ...
        $cropper.cropper({
            aspectRatio: <?php echo PLACES_HEADER_IMAGE_WIDTH;?> / <?php echo PLACES_HEADER_IMAGE_HEIGHT;?>,
            data: {
                x: 420,
                y: 50,
                width: 220,

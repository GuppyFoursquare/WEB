...
<script type="text/javascript" >
    $(document).ready(function() {
        ...
        $('#usersMasterTable').dataTable( {
            ...
            "sAjaxSource": "./ajax/member_management.php"
        });
                                ...
                                <form name="frmSearch" id="frmSearch" method="post" action="">
                                    ...
                                    <div style=" float:left; position:absolute;" class="formtopbox">
                                        <div style="left:0px; float:right; z-index:1; float:left; position:relative;">
                                            <div class="white12" style="vertical-align:middle;float:left;padding: 8px 5px;">Member Name: </div>
                                            <div style="float:left;margin-right: 10px;">
                                                <input type="text" name="usr_username" id="usr_username" style="width:150px;" value="<?php echo isset($_SESSION['Sessinomember_name']) ? stripslashes($_SESSION['Sessinomember_name']) : ''; ?>"/>
                                            </div>
                                        </div>
                                        <div style="left:0px; float:right; z-index:1; float:left; position:relative;">
                                        ...
                                        <input type="button" name="btnclear" value="Clear" id="btnClear" class="button left_menu_option" onclick="clearFilter();"/>
                                    </div>
                                    <div style="right:0px; float:right; z-index:1; position:relative;">
                                        ...
                                        <input type="button" name="add_edit" value="Add Member" id="add_edit" style="width:auto" onclick="location.href='add_edit_member.php'" class="button add_edit_member"/>
                                    </div>
                                    </div>
                                </form>
                            </td>

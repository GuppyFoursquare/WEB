    ...
    $(document).ready(function() {
        ...
        $('#newsMasterTable').dataTable( {
            ...
            "fnServerParams": function ( aoData ) {
                aoData.push( { "name": "news_title", "value": $('#news_title').val() } );	//to search paramatert
            },
            "aoColumnDefs" : [ {
                    "bSortable" : false,
                    "aTargets" : [ "no-sort" ]
            ...
            "sAjaxSource": "./ajax/news_specials_management.php"
        });
...
function searchTable(){
    search("newsMasterTable");
}    

function clearFilter(){
    $('#news_title').val('');
	$('#newsMasterTable').dataTable({ "bRetrieve": true }).fnSort([]);
    search("newsMasterTable");
}
                                ...
                                <form name="frmSearch" id="frmSearch" method="post" action="">
                                    ...
                                    <div style=" float:left; position:absolute;" class="formtopbox">
                                        <div style="left:0px; float:right; z-index:1; float:left; position:relative;">
                                            <div class="white12" style="vertical-align:middle;float:left;padding: 8px 5px;"><p>News Title: </p></div>
                                            <div style="float:left;margin-right: 10px;">
                                                <input type="text" name="news_title" id="news_title" style="width:90px;" value="<?php echo isset($_SESSION['Sessinonews_title']) ? stripslashes($_SESSION['Sessinonews_title']) : ''; ?>"/>
                                            </div>
                                        </div>
                                    ...
                                    <div style="right:0px; float:right; z-index:1; position:relative;">
                                        ...
                                        <input type="button" name="add_edit" value="Add News" id="add_edit" style="width:auto" onclick="location.href='add_edit_news_specials.php'" class="button add_edit_member"/>
                                    </div>
                                    </div>
                                </form>
                            </td>
                            ...
                            <td>
                                <form id="change_order" name="change_order" method="post">
                                    ...
                                    <div class="grid_content">
                                        <table cellpadding="0" cellspacing="0" border="0" class="display" id="newsMasterTable" width="100%">
                                            <thead>
                                                <tr>
                                                   <th class="blue_bg_header no-sort">SEQ. NO.</th>
													<th class="blue_bg_header">NEWS TITLE</th>
													<th class="blue_bg_header no-sort">NEWS IMAGE</th>

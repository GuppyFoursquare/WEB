    ...
    $(document).ready(function() {
        ...
        $('#offmenuMasterTable').dataTable( {
            ...
            "fnServerParams": function ( aoData ) {
                aoData.push( { "name": "cnt_page_heading", "value": $('#cnt_page_heading').val() } );	//to search paramatert
            },
            "aoColumnDefs" : [ {
                    "bSortable" : false,
                    "aTargets" : [ "no-sort" ]
            ...
            "sAjaxSource": "./ajax/off_menu_management.php"
        });
...
function searchTable(){
    search("offmenuMasterTable");
}    

function clearFilter(){
    $('#cnt_page_heading').val('');
	$('#offmenuMasterTable').dataTable({ "bRetrieve": true }).fnSort([]);
    search("offmenuMasterTable");
}
                                ...
                                <form name="frmSearch" id="frmSearch" method="post" action="">
                                    ...
                                    <div style=" float:left; position:absolute;" class="formtopbox">
                                        <div style="left:0px; float:right; z-index:1; float:left; position:relative;">
                                            <div class="white12" style="vertical-align:middle;float:left;padding: 8px 5px;"><p>Menu Name:</p> </div>
                                            <div style="float:left;margin-right: 10px;">
                                                <input type="text" name="cnt_page_heading" id="cnt_page_heading" style="width:90px;" value="<?php echo isset($_SESSION['Sessinopage_heading']) ? stripslashes($_SESSION['Sessinopage_heading']) : ''; ?>"/>
                                            </div>
                                        </div>
                                    ...
                                    <div style="right:0px; float:right; z-index:1; position:relative;">
                                        ...
                                        <input type="button" name="add_edit" value="Add Off Menu" id="add_edit" style="width:auto" onclick="location.href='add_edit_off_menu.php'" class="button add_edit_member"/>
                                    </div>
                                    </div>
                                </form>
                            </td>
                            ...
                            <td>
                                <form id="change_order" name="change_order" method="post">
                                    ...
                                    <div class="grid_content">
                                        <table cellpadding="0" cellspacing="0" border="0" class="display" id="offmenuMasterTable" width="100%">
                                            <thead>
                                                <tr>
												<th class="blue_bg_header no-sort">SEQ. NO.</th>
                                                    <th class="blue_bg_header">MENU NAME</th>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td colspan="4" class="dataTables_empty">Please wait.. fetching records.</td>
                                                </tr>
                                            </tbody>
                                            <tfoot>
                                            </tfoot>

...
<script type="text/javascript" >
    $(document).ready(function() {
        ...
        $('#sliderMasterTable').dataTable( {
            ...
            "sAjaxSource": "./ajax/slider_management.php"
        });
                            ...
                            <td style="">
                                <form name="frmSearch" id="frmSearch" method="post" action="">
                                    ...
                                    <div style="right:0px; float:right; z-index:1; position:relative;">
                                        ...
                                        <input type="button" name="add_edit" value="Add Image" id="add_edit" style="width:auto" onclick="location.href='add_edit_slider.php'" class="button add_edit_member"/>
                                    </div>
                                    </div>
                                </form>
                            </td>

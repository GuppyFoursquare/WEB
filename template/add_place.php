            ...
            var demo1 = $("#demo1").slippry({
                ...
                $('#frmAddPlace').validate({
                    ...
                    messages:{
                        ...
                        place_name:{required:"Please enter place name."},
                ...
                <div class="col_left">
                    	<div class="category_box">
                            <div class="category_box_in">
                                <div class="heading1">Add Your Place</div>
                                
                                <form id="frmAddPlace" action="" method="POST">
                                        <div class="form_contact_us">
                                            <div class="form-control">
                                                <label class="form_label">Your Name: <span class="error">*</span></label>
                                                <div class="form-input-out">
                                                <input class="form-input" id="member_name_contact" name="member_name"/>
                                                </div>
                                            </div>
                                            <div class="form-control">
                                                <label class="form_label">Place Name: <span class="error">*</span></label>
                                                <div class="form-input-out">
                                                <input class="form-input" id="place_name" name="place_name"/>
                                                </div>
                                            </div>
                                            <div class="form-control">
                                            ...
                                            <div class="form-control">
                                                ...
                                                <input type="submit" name="submit" class="contact_submit" value="Send Request"/>
                                            </div>
                                        </div>
                                    </form>
                            </div>

                ...
                <div class="col_left">
                    	<div class="category_box">
                            <div class="category_box_in">
                                ...
                                <div class="heading1"><?php echo $rows > 0 ? $content['cnt_page_heading'] : 'Page Not Found';?></div>
                                ...
                                <?php else:?>
                                    <div style="text-align: center;color: #fff;font-size: 16px;">The page you are looking for does not exist.</div>
                                <?php endif?>

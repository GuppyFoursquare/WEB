...
<script  type="text/javascript" src="js/mobitouch.js" ></script>
...
$(document).ready(function(){
	$('#menu').slicknav();
        var textbox_val = '';
        $(".loginbox").removeClass("loginbox2");
      ...
      ?>
        ...
        $("#map_btn_mob").click(function(){
         ...
         $("input.search_input123").on('keyup',function(event) {
                var keycode = (event.keyCode ? event.keyCode : event.which);
                textbox_val = $(this).val();
         ...
         $(".search_btn").on("click",function(){
             //alert($(".search_input123").val());
             //alert(textbox_val);
             
             var str = $("#site_path").val()+"home_page.php?";
             if($(".ez-checkbox-green").hasClass('ez-checked-green'))
             {
                 str = str + "chbexactsearch=on&";
             }
             str = str + "sr="+textbox_val
             //alert(str);
        ...
        <?php if(isset($chbExactSearch)):?>
            <?php if($chbExactSearch):?>
                $('#chbexactsearch12').prop('checked','true');
...
<div id="header-top_in">
        <div id="header-top">
            <div class="headermid">
                <div class="headermid1">
                    <h1 class="logo">
                        <a href="<?php echo SITE_PATH.'index.php';?>">
                            <img src="images/baku_logo.png" style="border: none" alt="Logo" />
                        </a>
                    </h1>
                        <div class="headermid_right">
                            ...
                            <ul>
                                ...
                                <form id="frmSearch" action="home" method="get">
                                    <label style="display: none;" for="chbexactsearch" class="exact_search_lbl">Exact search</label>
                                    <input style="display: none;" type="checkbox" id="chbexactsearch" name="chbexactsearch"/>
                                    <input id="txtSearch" name="sr" type="text" value="<?php echo (isset($_GET['sr']) ? htmlentities($_GET['sr']) : '');?>" placeholder="Search for ..." class="searchfield" />
                                    <input value="" type="submit" class="searchbutton" />
                                </form>
                                </li>
                                <li class="a1 home_link"><a href="javascript:void(0);" >HOME</a></li>
                                <li class="a1"><a href="<?php echo SITE_PATH.'nearme';?>" >near me</a></li>
                                <li class="a1"><a href="<?php echo SITE_PATH.'most-popular';?>">most popular</a>
                                        <!--<div class="dropdown">
                                        <div class="dropdownlefsec">
                                            <ul>
                                            <li><a href="javascript:void(0);">Serveis1</a></li>
                                            <li><a href="javascript:void(0);">Serveis2</a></li>
                                            </ul>
                                        </div>
                                        </div>-->
                                </li>
                                <li class="a1"><a href="<?php echo SITE_PATH.'content/'.$about_us['cnt_url_name'];?>" >About us</a></li>
                                <?php if(!isset($_SESSION['user_id'])) { ?><li class="a1"><a href="javascript:void(0);" class="search lnkLogin">login</a></li> 
                                    <?php } else {?>
                                                <li class="a1 welcome_text" onclick="toggleProfileOptions()" style="margin: 0px;"><a href="javascript:void(0);" style="padding: 3px 5px;min-width: 175px;"><?php echo strlen($_SESSION['usr_first_name'])>18 ? substr($_SESSION['usr_first_name'], 0, 18).'..' : $_SESSION['usr_first_name'];?><img src="<?php echo $_SESSION['usr_profile_picture'] != '' ? PROFILE_IMAGE.$_SESSION['usr_profile_picture'] : PROFILE_IMAGE.'default.png';?>" style="width:20px;margin:0 5px;height: 20px;vertical-align: middle;"/><img class="caret_arrow_image" src="images/bottom-arrow.png" style="width: 10px;vertical-align: middle;"/></a></li>
                                ...
                                <li  class="a2 search_btn1_mob"><a href="<?php echo SITE_PATH.'home_page.php';?>" class="search2 <?php echo isset($search2act)? $search2act : '';?>"></a></li>
                                ...
                                <li class="a3 a4">
                                    ...
                                    <input placeholder="Search for Bar, Restaurant, Club, ..." class="search_input123" id="search_input123" name="search_input123" type="text" value="" /> <a class="btn_close" href="javascript:void(0);"></a></li>
                                <li class="a2 popular_btn_mob"><a href="<?php echo SITE_PATH.'most-popular';?>" class="<?php echo $class_name;?> popular"></a>	
                                </li>
                                <li class="a2 map_btn_mob"><a href="<?php echo SITE_PATH.'nearme';?>" class="map <?php echo isset($mapact)? $mapact : '';?>"></a></li>
                                <?php if(!isset($_SESSION['user_id'])):?>
                                    <li class="a2 login_btn_mob"><a href="javascript:void(0);" class="login"></a></li>
                                <?php else:?>
                                    <li class="a2"><a href="<?php echo SITE_PATH.'view/profile/'.$_SESSION['usr_username'];?>" class="login <?php echo isset($editclass)? $editclass : '';?>"></a></li>
                                <?php endif?>

                                                
                                <!--li class="a2"><a href="javascript:void(0);" class="act searchact"></a></li>
                                <li class="a5"><a href="javascript:void(0);" class="act searchact"></a></li>
                                <li class="a3"><input type="text" class=""/> <a href="javascript:void(0);"></a></li>
                                <li class="a2 a4"><a href="javascript:void(0);" class="popular"></a>	
                                </li>
                                <li class="a2 a4"><a href="javascript:void(0);" class="search2"></a></li>
                                <li class="a2 a4"><a href="javascript:void(0);" class="map"></a></li>
                                <li class="a2 a4"><a href="javascript:void(0);" class="login"></a></li-->	
                            </ul>
                        </nav>
                    </div>
